...
public class GeradorDeDisputas {
    ...
    public static List<List<Pair<Long, Long>>> gerarDisputas(List<Long> atletas, int quantidadeRodadas) {
...
//                 }
    ...
    public static List<Long> embaralha(List<Long> atletas){
...
//        );
        ...
        resultado = gerarDisputas(embaralha(atletas), rodadas);
...
//        System.out.println(embaralha(atletas));
//        System.out.println(embaralha(atletas));
//        System.out.println(embaralha(atletas));
    }
}
